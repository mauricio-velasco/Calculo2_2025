...
\begin{enumerate}
\item Una función $f:X\subseteq \mathbb{R}^n\rightarrow \mathbb{R}^m$ es diferenciable en $\vec{a}\in X^{\circ}$ si y solo si sus funciones componentes $f_i:=\pi_i\circ f$ para $i=1,\dots,m$ son diferenciables en $\vec{a}$.
\item Sea $g: X\subseteq \mathbb{R}^n\rightarrow \mathbb{R}$ una función escalar y sea $\vec{a}\in X^{\circ}$. Si las $n$ funciones $\frac{\partial g}{\partial x_j}(x_1,\dots, x_n)$ para $j=1,\dots, n$ estan definidas en algún entorno de $\vec{a}$ y son continuas en $\vec{a}$ entonces $g$ es diferenciable en $a$.
\end{enumerate}


\item Hallar la mejor aproximaci\'{o}n lineal de $f(x,y)=\sqrt{20-x^{2}-7y^{2}}$ en $%
