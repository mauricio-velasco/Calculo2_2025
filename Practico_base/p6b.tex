...
\item\label{bonus7-1} Sea $f:\R \to \R$ definida por $f(x) =
 ...
 \item \textit{Regresi\'on lineal.}  Dados $(x_1,y_1),\dots
  ...
  $T\cdot(u_1-u_2)=0$, siendo $T$ el vector
  unitario tangente a la elipse en $(x,y)$ y $u_i$ los vectores unitarios desde $(x,y)$ hacias sus focos. Interpretar geom\'etricamente este
